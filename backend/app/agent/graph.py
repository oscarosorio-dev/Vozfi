...
_SYSTEM_PROMPT = (
    ...
    "CLASIFICACIÓN income/expense: 'expense' es dinero que SALE del usuario (gastar, pagar, "
    "comprar, sacar dinero para algo, invertir, retirar). 'income' es dinero que ENTRA al "
    "usuario (recibir, cobrar, ganar salario, vender algo). Sacar o invertir dinero en una "
    "compra (ej: 'saqué 1 millón para comprar una moto') es SIEMPRE 'expense', nunca 'income'.\n\n"
